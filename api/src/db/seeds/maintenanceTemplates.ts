...
const TEMPLATES = [
  ...
  {
    categorySlug: "water",
    name: "Water filter full service",
    taskType: "full_service" as const,
    defaultCalDays: 365,
    graceDays: 14,
  },
  // Power
  ...
  // Batteries
  {
    ...
    name: "Li-Ion storage recharge",
    taskType: "recharge" as const,
    defaultCalDays: 90,
    graceDays: 7,
  },
  {
    categorySlug: "batteries",
    name: "Lead-acid charge check",
    taskType: "inspect" as const,
    defaultCalDays: 30,
    graceDays: 5,
  },
  {
    categorySlug: "batteries",
    name: "Battery bank capacity test",
    taskType: "test" as const,
    defaultCalDays: 180,
    graceDays: 14,
  },
  ...
  {
    categorySlug: "comms",
    name: "Radio test and battery check",
    taskType: "test" as const,
    defaultCalDays: 90,
    graceDays: 7,
  },
  ...
  // Mobility / Vehicles
  {
    ...
    name: "Vehicle emergency kit check",
    taskType: "inspect" as const,
    defaultCalDays: 180,
    graceDays: 14,
  },
