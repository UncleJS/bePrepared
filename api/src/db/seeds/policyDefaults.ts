...
export async function seedPolicyDefaults() {
  ...
  const defaults = [
    {
      ...
      valueInt:     null,
      unit:         "L/person/day",
      description:  "Drinking + minimal food prep and basic hygiene. WHO emergency minimum is 2L/day; 4L provides a realistic planning buffer.",
    },
    {
      ...
      description:  "Baseline adult mixed-household caloric planning value. Sedentary adult minimum is ~1800; 2200 covers light-activity shelter operations.",
    },
    {
      ...
      valueInt:     14,
      unit:         "days",
      description:  "Number of days ahead to generate 'upcoming' alerts for expiry, replacement, and maintenance.",
    },
    {
  ...
  for (const row of defaults) {
    await db.insert(policyDefaults)
      .values(row)
