...
export const maintenanceRoute = new Elysia({ prefix: "/maintenance", tags: ["maintenance"] })
  .get("/templates", async ({ request, set }) => {
  ...
  .post("/templates", async ({ request, set, body }) => {
  ...
  .get("/:householdId/schedules", async ({ request, set, params }) => {
  ...
  .post("/:householdId/:equipmentItemId/schedules", async ({ request, set, params, body }) => {
    const claims = requireHouseholdScope(request, set, params.householdId);
    if (!claims) return { error: "Forbidden" };
  ...
  .patch("/:householdId/schedules/:scheduleId", async ({ request, set, params, body }) => {
    const claims = requireHouseholdScope(request, set, params.householdId);
    if (!claims) return { error: "Forbidden" };
  ...
  .delete("/:householdId/schedules/:scheduleId", async ({ request, set, params }) => {
    const claims = requireHouseholdScope(request, set, params.householdId);
    if (!claims) return { error: "Forbidden" };
  ...
  .post("/:householdId/schedules/:scheduleId/events", async ({ request, set, params, body }) => {
    const claims = requireHouseholdScope(request, set, params.householdId);
    if (!claims) return { error: "Forbidden" };
  ...
  .get("/:householdId/schedules/:scheduleId/events", async ({ request, set, params }) => {
    const claims = requireHouseholdScope(request, set, params.householdId);
    if (!claims) return { error: "Forbidden" };
  ...
  .get("/:householdId/due", async ({ request, set, params, query }) => {
    const claims = requireHouseholdScope(request, set, params.householdId);
    if (!claims) return { error: "Forbidden" };
