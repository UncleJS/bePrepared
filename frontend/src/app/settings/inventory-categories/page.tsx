        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 rounded-lg border border-border bg-card p-4">
          ...
          <div className="flex gap-2 self-end">
            <button
              ...
              onClick={async () => {
                try {
                  await apiFetch(`/inventory/${householdId}/categories/${editingId}`, {
                    method: "PATCH",
                    body: JSON.stringify({
                      name: editName,
                      slug: editSlug,
              ...
              onClick={async () => {
                try {
                  const path = replacementId
                    ? `/inventory/${householdId}/categories/${archiveId}?replacementCategoryId=${encodeURIComponent(replacementId)}`
                    : `/inventory/${householdId}/categories/${archiveId}`;
